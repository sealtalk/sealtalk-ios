...
- (void) addHeadViewUser:(RCUserInfo *)user {
    {
        ...
        [userHead sd_setImageWithURL:[NSURL URLWithString:user.portraitUri] placeholderImage:[RCDUtilities imageNamed:@"default_portrait_msg" ofBundle:@"RongCloud.bundle"]];
...
////    if (user.portraitUri) {
////        NSData *data = [NSData dataWithContentsOfURL:[NSURL URLWithString:user.portraitUri]];
////        if (data) {
////            return [UIImage imageWithData:data];
////        } else {
////            return [self imageNamed:@"default_portrait_msg" ofBundle:@"RongCloud.bundle"];
////        }
////    } else {
//        return [self imageNamed:@"default_portrait_msg" ofBundle:@"RongCloud.bundle"];
//    //}
