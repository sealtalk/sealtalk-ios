...
-(void) clickedDone:(id) sender
{
    ...
    if (self.forCreatingGroup) {
        ...
        RCDCreateGroupViewController *createGroupVC = [mainStoryboard instantiateViewControllerWithIdentifier:@"RCDCreateGroupViewController"];
...
//                if ([userId isEqualToString:user.userId])
//                {
//                    [currentGroupMembers addObject:[_friendsArr objectAtIndex:i]];
//                    break;
//                }
//            }
//        }
