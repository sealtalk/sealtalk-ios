...
//    self.InviteMemberCount.text = [NSString stringWithFormat:@"被邀请成员(%ld)",(long)membersCount];
//    
...
//    RCDGroupMemberCollectionViewCell *cell = (RCDGroupMemberCollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
...
//    {
//
//        [cell.PortraitImageView sd_setImageWithURL:[NSURL URLWithString:user.portraitUri] placeholderImage:[UIImage imageNamed:@"icon_person"]];
//    }
