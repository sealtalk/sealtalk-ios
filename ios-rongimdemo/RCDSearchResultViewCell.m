...
- (void)setDataModel:(RCDSearchResultModel *)model{
  ...
  if (!(model.portraitUri.length>0)) {
    ...
    [self.headerView sd_setImageWithURL:[NSURL URLWithString:model.portraitUri] placeholderImage:[RCDUtilities imageNamed:@"default_portrait_msg" ofBundle:@"RongCloud.bundle"]];
  }
}
