...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided rp_setImageWithURL: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView rp_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
 ...
 * @endcode
 */
@interface UIImageView (YZHWebCache)

/**
 * Get the current image URL.
 *
 * Note that because of the limitations of categories this property can get out of sync
 * if you use rp_setImage: directly.
 */
- (NSURL *)rp_imageURL;
 ...
 * @see rp_setImageWithURL:placeholderImage:options:
 */
