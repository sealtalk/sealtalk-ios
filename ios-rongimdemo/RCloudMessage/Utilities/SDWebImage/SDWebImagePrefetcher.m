        ...
        downloadImageWithURL:self.prefetchURLs[index]
                   ...
                   completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished,
                       ...
                       if (image) {
                           ...
                           NSLog(@"Prefetched %@ out of %@ (Failed)", @(self.finishedCount),
...
- (void)reportStatus {
    ...
    NSLog(@"Finished prefetching (%@ successful, %@ skipped, timeElasped %.2f)", @(total - self.skippedCount),
          @(self.skippedCount), CFAbsoluteTimeGetCurrent() - self.startedTime);
