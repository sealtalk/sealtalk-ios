...
+ (UIImage *)decodedImageWithImage:(UIImage *)image {
    ...
    // It calculates the bytes-per-row based on the bitsPerComponent and width
    // arguments.
    ...
    UIImage *decompressedImage =
        [UIImage imageWithCGImage:decompressedImageRef scale:image.scale orientation:image.imageOrientation];
