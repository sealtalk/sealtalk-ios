 ...
 * and skips images for failed downloads and proceed to the next image in the
 * list
 *
 ...
 * or not) requests,
 *                        second parameter is the total number of images
 * originally requested to be prefetched
 * @param completionBlock block to be called when prefetching is completed
 *                        first param is the number of completed (successful or
 * not) requests,
