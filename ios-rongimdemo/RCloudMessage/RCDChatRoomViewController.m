...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        self.tabBarItem.image =
            [[UIImage imageNamed:@"icon_room"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        self.tabBarItem.selectedImage =
            [[UIImage imageNamed:@"icon_room_hover"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RCDChatRoomTableViewCell *cell =
        (RCDChatRoomTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
