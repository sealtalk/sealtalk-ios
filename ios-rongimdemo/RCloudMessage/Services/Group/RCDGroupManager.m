...
+ (void)setGroupPortrait:(NSString *)portraitUri groupId:(NSString *)groupId complete:(void (^)(BOOL))complete{
    [RCDGroupAPI setGroupPortrait:portraitUri groupId:groupId complete:^(BOOL success) {
        if (success) {
...
+ (void)setGroupName:(NSString *)groupName groupId:(NSString *)groupId complete:(void (^)(BOOL))complete{
    [RCDGroupAPI resetGroupName:groupName groupId:groupId complete:^(BOOL success) {
        if (success) {
            RCDGroupInfo *groupInfo = [RCDDBManager getGroup:groupId];
...
+ (void)getGroupInfoFromServer:(NSString *)groupId complete:(void (^)(RCDGroupInfo * _Nonnull))complete{
    [RCDGroupAPI getGroupInfo:groupId complete:^(RCDGroupInfo * _Nonnull groupInfo) {
        if (groupInfo) {
            [RCDDBManager saveGroups:@[groupInfo]];
...
+ (void)quitGroup:(NSString *)groupId
    ...
    [RCDGroupAPI quitGroup:groupId complete:^(BOOL success) {
        if (success) {
...
+ (void)dismissGroup:(NSString *)groupId complete:(void (^)(BOOL success))complete{
    [RCDGroupAPI dismissGroup:groupId complete:^(BOOL success) {
        if (success) {
            [RCDDBManager deleteGroup:groupId];
            [self getMyGroupListFromServer:nil];
        }
...
//发布群公告
+ (void)publishGroupAnnouncement:(NSString *)content groupId:(NSString *)groupId complete:(void (^)(BOOL success))complete{
    [RCDGroupAPI publishGroupAnnouncement:content groupId:groupId complete:^(BOOL success) {
        if (success) {
...
+ (void)getGroupMembersFromServer:(NSString *)groupId complete:(void (^)(NSArray<NSString *> *))complete{
    [RCDGroupAPI getGroupMembers:groupId complete:^(NSArray<RCDGroupMember *> * _Nonnull memberList) {
        if (memberList) {
...
+ (void)kickUsers:(NSArray *)userIds
          groupId:(NSString *)groupId
         complete:(void (^)(BOOL success))complete{
    [RCDGroupAPI kickUsers:userIds groupId:groupId complete:^(BOOL success) {
        if (success) {
            [self syncGroup:groupId];
        }
        if (complete) {
...
+ (void)transferGroupOwner:(NSString *)targetId
                   groupId:(NSString *)groupId
                  complete:(void (^)(BOOL success))complete{
    [RCDGroupAPI transferGroupOwner:targetId groupId:groupId complete:^(BOOL success) {
        if (complete) {
            complete(success);
        }
    }];
...
+ (void)addGroupManagers:(NSArray<NSString *> *)userIds
                 groupId:(NSString *)groupId
                complete:(void (^)(BOOL success))complete{
    [RCDGroupAPI addGroupManagers:userIds groupId:groupId complete:^(BOOL success) {
        if (complete) {
            complete(success);
        }
    }];
...
+ (void)removeGroupManagers:(NSArray<NSString *> *)userIds
                    groupId:(NSString *)groupId
                   complete:(void (^)(BOOL success))complete{
    [RCDGroupAPI removeGroupManagers:userIds groupId:groupId complete:^(BOOL success) {
        if (complete) {
            complete(success);
        }
    }];
...
+ (void)addToMyGroups:(NSString *)groupId complete:(void (^)(BOOL success))complete{
    [RCDGroupAPI addToMyGroups:groupId complete:^(BOOL success) {
        if (success) {
...
+ (void)removeFromMyGroups:(NSString *)groupId complete:(void (^)(BOOL))complete{
    [RCDGroupAPI removeFromMyGroups:groupId complete:^(BOOL success) {
        if (success) {
            [self getMyGroupListFromServer:nil];
        }
        if (complete) {
