...
enum MAX_DEVICE_ID_LENGTH_TYPE { MAX_DEVICE_ID_LENGTH = 128 };
...
public:
  ...
  * @return returns true to send out the packet, returns false to discard the
  * packet
  */
  ...
  *      buffer *buffer points the data to be sent
  *      size of buffer data to be sent
  * @return returns true to process the packet, returns false to discard the
  * packet
  */
...
public:
  ...
  * @param [in] elapsed
  *        the time elapsed in ms from the joinChannel been called to joining
  * completed
  */
  ...
  */
  ...
  /**
  * when the information of the RTC engine stats come, the function will be
  * called
  * @param [in] stat
  ...
  */
  ...
  /**
  * when the audio device state changed(plugged or removed), the function will
  * be called
  * @param [in] deviceId
  ...
  */
  ...
  /**
  * when the video device state changed(plugged or removed), the function will
  * be called
  * @param [in] deviceId
  ...
  */
  virtual void onNetworkQuality(int quality) { (void)quality; }
...
*    @param [in] height
  *        the height of the video frame
  * @param [in] elapsed
  *        the time elapsed from remote used called joinChannel to joining
* completed in ms
  */
  ...
  /**
  * when user offline(exit channel or offline by accident), the function will be
  * called
  * @param [in] uid
  *        the UID of the remote user
  */
  ...
  *        the UID of the remote user
  * @param [in] muted
  *        true: the remote user muted the audio stream, false: the remote user
  * unmuted the audio stream
  */
  ...
  *        the UID of the remote user
  * @param [in] muted
  *        true: the remote user muted the video stream, false: the remote user
  * unmuted the video stream
  */
  ...
  *        the UID of the remote user
  * @param [in] enabled
  *        true: the remote user has enabled video function, false: the remote
  * user has disabled video function
  */
...
*/
  ...
  */
  ...
  /**
  * when all video stopped, the function will be called then you can repaint the
  * video windows
  */
  ...
  */
  ...
  /**
  * when local user disconnected by accident, the function will be called(then
  * SDK will try to reconnect itself)
  */
...
public:
  ...
  * @param [in] deviceId
  *        the deviceId of the recording audio device you want to active
  * currently
  * @return return 0 if success or the error code.
  */
  ...
  * @return return 0 if success and you can hear the sound of the .wav file or
  * an error code.
  */
...
public:
  ...
  */
  ...
  /**
  * join the channel, if the channel have not been created, it will been created
* automatically
* @param [in] key
  *        the vendor key, if you have initialized the engine with an available
* vendor key, it can be null here
  * @param [in] channel
  *        the channel number
* @param [in] info
  *        the additional information, it can be null here
  * @param [in] uid
  *        the uid of you, if 0 the system will automatically allocate one for
* you
  * @return return 0 if success or an error code
  */
  virtual int joinChannel(const char *key, const char *channel,
  ...
  */
  ...
  /**
  * start the echo testing, if every thing goes well you can hear your echo from
  * the server
  * @return return 0 if success or an error code
  */
  ...
  */
  ...
  /**
  * register a packet observer while the packet arrived or ready to be sent, the
  * observer can touch the packet data
  * @param [in] observer
...
public:
  ...
  */
  ...
  // mute/unmute all peers. unmute will clear all muted peers specified
  // mutePeer() interface
  /**
  ...
  */
  int muteLocalVideoStream(bool mute) {
    return setParameters(
        "{\"rtc.video.mute_me\":%s,\"che.video.local.send\":%s}",
