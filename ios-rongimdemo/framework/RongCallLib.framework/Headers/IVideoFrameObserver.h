...
public:
  virtual bool onCaptureVideoFrame(const unsigned char **yBuffer,
                                   const unsigned char **uBuffer,
                                   const unsigned char **vBuffer,
                                   unsigned int &width, unsigned int &height,
                                   unsigned int &yStride, unsigned int &uStride,
                                   unsigned int &vStride) = 0;
  virtual bool onRenderVideoFrame(const unsigned char **yBuffer,
                                  const unsigned char **uBuffer,
                                  const unsigned char **vBuffer,
                                  unsigned int &width, unsigned int &height,
                                  unsigned int &yStride, unsigned int &uStride,
                                  unsigned int &vStride) = 0;
  virtual bool onExternalVideoFrame(
...
extern "C" {
#endif
int RCRegisterVideoFrameObserver(
    RongCloud::media::IVideoFrameObserver *observer,
