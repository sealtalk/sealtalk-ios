...
- (void)viewDidLoad {
    ...
    self.offLineMessageTimeLabel = [[UILabel alloc]initWithFrame:CGRectMake(50, 50, self.view.bounds.size.width-100, 50)];
    ...
    [self.offLineMessageTimeLabel setText:[NSString stringWithFormat:@"%d 天",[[RCIMClient sharedRCIMClient] getOfflineMessageDuration]]];
    [self.view addSubview:self.offLineMessageTimeLabel];
    
    self.setTimeTextField = [[UITextField alloc]initWithFrame:CGRectMake(50, 150, self.view.bounds.size.width-100, 50)];
    ...
    self.confirmBtn = [[UIButton alloc]initWithFrame:CGRectMake((self.view.bounds.size.width-100)/2, 250, 100, 50)];
