...
- (UILabel *)infoLabel {
    if (!_infoLabel) {
        ...
        _infoLabel.textColor = RCDDYCOLOR(0x939393, 0xAAAAAA);
...
- (UILabel *)tipLabel {
    if (!_tipLabel) {
        ...
        _tipLabel.textColor = [RCDUtilities generateDynamicColor:HEXCOLOR(0x939393) darkColor:[HEXCOLOR(0xffffff) colorWithAlphaComponent:0.8]];
...
- (UIButton *)confirmBotton {
    if (!_confirmBotton) {
        ...
        _confirmBotton.backgroundColor = HEXCOLOR(0x0099ff);
        ...
        _confirmBotton.layer.cornerRadius = 8;
    }
